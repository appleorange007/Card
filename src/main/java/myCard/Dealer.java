...
class Dealer {
    ...
    Dealer(SHinterface sh, Image cardspic, Graphics g, Hand hand, Image back, Image backSW,
            boolean fastgame, boolean seven, boolean nine, boolean swap, Image[] pointer,
            Image burntPic, Score score)
    {
        this.sh = sh;
    ...
    {
        String command = "otherdetails:" + otherNames[1] + ":" + hands[1].getFaceUp(0).getNumber()
                + ":" + hands[1].getFaceUp(1).getNumber() + ":"
                + hands[1].getFaceUp(2).getNumber() + ":" + otherNames[2] + ":"
                + +hands[2].getFaceUp(0).getNumber() + ":"
                + hands[2].getFaceUp(1).getNumber() + ":" + hands[2].getFaceUp(2).getNumber() + ":"
                + playersName + ":"
                + hands[3].getFaceUp(0).getNumber() + ":" + +hands[3].getFaceUp(1).getNumber()
                + ":" + hands[3].getFaceUp(2).getNumber() + ":";
        sendCommand(command, 0);

        command = "otherdetails:" + otherNames[2] + ":" + hands[2].getFaceUp(0).getNumber() + ":"
                + hands[2].getFaceUp(1).getNumber() + ":"
                + hands[2].getFaceUp(2).getNumber() + ":" + playersName + ":"
                + +hands[3].getFaceUp(0).getNumber() + ":"
                + hands[3].getFaceUp(1).getNumber() + ":" + hands[3].getFaceUp(2).getNumber() + ":"
                + otherNames[0] + ":"
                + hands[0].getFaceUp(0).getNumber() + ":" + +hands[0].getFaceUp(1).getNumber()
                + ":" + hands[0].getFaceUp(2).getNumber() + ":";
        sendCommand(command, 1);

        command = "otherdetails:" + playersName + ":" + hands[3].getFaceUp(0).getNumber() + ":"
                + hands[3].getFaceUp(1).getNumber() + ":"
                + hands[3].getFaceUp(2).getNumber() + ":" + otherNames[0] + ":"
                + +hands[0].getFaceUp(0).getNumber() + ":"
                + hands[0].getFaceUp(1).getNumber() + ":" + hands[0].getFaceUp(2).getNumber() + ":"
                + otherNames[1] + ":"
                + hands[1].getFaceUp(0).getNumber() + ":" + +hands[1].getFaceUp(1).getNumber()
    ...
    private void outofgame(int playerout)
    {
        ...
        if (playerout == 3) {// dealer out of game
            if (position == 1)
                sh.addMsg("Well done you have won the game your the first out !!");
            else if (position == 2)
        ...
        if (position == 4) {
            ...
            // sending message to everyone else
            for (int n = 0; n < 3; n++)
                if (otherNames[n] != name)
                    sendCommand("lost:" + name + ":", n);
    ...
    public void cardSelection(int cardno)
    {
        ...
        if (hands[3].getCard(0) == null) {// if player only has cards on table
            if (hands[3].getFaceUp(0) != null || hands[3].getFaceUp(1) != null
                ...
                if (isValidCard(card, command)) {
                    ...
                    if (hands[3].getFaceDown(0) == null && hands[3].getFaceDown(1) == null
                    ...
                    for (int n = 0; n < 3; n++)
                        sendCommand("othersturn:" + playersName + ":facedown:pickup:"
                                + hands[3].getFaceDown(cardno).getNumber() + ":", n);
                    for (int n = 0; n < 52; n++) {
                        if (pile[n] == null)
                            break;
            ...
            // checking if player is out of the game
            if (hands[3].getFaceDown(0) == null && hands[3].getFaceDown(1) == null
                    && hands[3].getFaceDown(2) == null && hands[3].getCard(0) == null) {
                outofgame(3);
                if (whosturn == 3)
                    nextTurn();
            }
    ...
    private boolean checkformultiFaceUp(Card card)
    {
            ...
            if (card.getValue() == 9 && nine == true) {
                ...
                if (pile[count] != null) {
                    if (card.getValue() == 9) {
                        ...
                        if (card.getValue() >= 7)
                            return false;
                    } else if (!(card.getValue() == 2 || card.getValue() == 10 || card.getValue() >= pile[count]
                            .getValue()))
                        return false;
                }
                ...
                if (card.getValue() >= 7)
                    return false;
            } else if (!(card.getValue() == 2 || card.getValue() == 10 || card.getValue() >= pile[0]
                    .getValue()))
                return false;
        }
        ...
        for (int n = 0; n < 3; n++) {
            if (hands[3].getFaceUp(n) != null)
                if (hands[3].getFaceUp(n).getValue() == card.getValue())
                    amountinhand++;
        }
        if (amountinhand <= 1)
            return false;
        ...
        if (numbertoplay <= 1)
            return false;
        String command = "othersturn:" + playersName + ":faceup:multi:" + numbertoplay + ":"
                + card.getNumber() + ":";
        addcardtopile(card);
        numbertoplay--;
        for (int n = 0; n < 3; n++)
    ...
    private boolean checkformulti(Card card)
    {
        ...
        for (int n = 0; n < hands[3].length(); n++) {
            if (hands[3].getCard(n) == null)
                break;
            if (hands[3].getCard(n).getValue() == card.getValue())
                amountinhand++;
        }
        if (amountinhand <= 1)
            return false;
        ...
        if (numbertoplay <= 1)
            return false;
        String command = "othersturn:" + playersName + ":multi:" + numbertoplay + ":"
                + card.getNumber() + ":";
        addcardtopile(card);
        numbertoplay--;
    ...
    public boolean isValidCard(Card card, String command)
    {
        ...
        if (card.getValue() == 2) {// 2 can be played at anytime
            ...
            return true;
        } else if (card.getValue() == 10 || fourOfAKind(card)) {// pile is burn and its players turn
                                                                // again
            burnt = true;
            for (int n = 0; n < 51; n++)
                pile[n] = null;
    ...
    public void processTurn(String otherplayermsg, int commandlength)
    {
        ...
        if (variable.equals("pickup")) {// if other player picks up deck
            ...
            for (int n = 0; n < 3; n++)
                if (n != whosturn)
                    sendCommand("othersturn:" + otherNames[whosturn] + ":pickup:", n);
            ...
            if (cardno.equals("multi")) {
                ...
                for (int n = 0; n < 3; n++)
                    if (n != whosturn)
                        sendCommand("othersturn:" + otherNames[whosturn] + ":faceup:" + cardno
                                + ":", n);
            }
            ...
            String cardno = otherplayermsg.substring(varlength + 1, varlength2);
            if (cardno.equals("pickup")) {// card that was played facedown made player pick up the
                                          // deck
                    ...
                    if (hands[whosturn].getFaceDown(n) != null)
                        if (hands[whosturn].getFaceDown(n).getNumber() == cardNo) {
                            if (hands[whosturn].getFaceDown(n).getValue() == 10
                                    || fourOfAKind(hands[whosturn].getFaceDown(n)) == true) {// if
                                                                                             // card
                                                                                             // is
                                                                                             // 10
                                                                                             // burning
                ...
                for (int n = 0; n < 3; n++)
                    if (n != whosturn)
                        sendCommand("othersturn:" + otherNames[whosturn] + ":facedown:" + cardno
                                + ":", n);
            ...
            // if players hand is less than 3 card ands card still in deck give another card to
            // player
            ...
            for (int n = 0; n < 3; n++)
                if (n != whosturn)
                    sendCommand(command, n);
            // Check for out of game
            if (hands[whosturn].getFaceDown(0) == null && hands[whosturn].getFaceDown(1) == null
                    && hands[whosturn].getFaceDown(2) == null && hands[whosturn].getCard(0) == null)
                outofgame(whosturn);
            ...
            for (int n = 0; n < hands[whosturn].length() - 1; n++) {
                ...
                if (hands[whosturn].getCard(n).getNumber() == cardno) {
                    if (hands[whosturn].getCard(n).getValue() == 10
                            || fourOfAKind(hands[whosturn].getCard(n)) == true) {// if card is 10
                                                                                 // burning the deck
                        burnt = true;
                        for (int i = 0; i < 52; i++)
                            pile[i] = null;
            ...
            if (burn) {
                ...
                for (int n = 0; n < 3; n++)
                    if (n != whosturn)
                        sendCommand("othersturn:" + otherNames[whosturn] + ":burn:", n);
            } else {
                // sending move to other players
                for (int n = 0; n < 3; n++)
                    if (n != whosturn)
    ...
    class WaitforMsg implements Runnable {
        ...
        public void run()
        {
            ...
            sh.addMsg("Player " + otherNames[socketNumber]
                    + " Game Socket Has Disconnected \nReplacing player with GameAI");
            sendMsg("Player " + otherNames[socketNumber]
        ...
        public void run()
        {
            ...
            do {
                ...
                try {
                    ...
                    // sh.addMsg("Error Accept " + e2);//removing error notice as apears when game
                    // is started early
                    endlook = true;
                }
                    ...
                    try {
                        ...
                        in[socketCount] = new BufferedReader(
                                new InputStreamReader(
                                        gameSocket[socketCount].getInputStream()));
                    } catch (IOException e) {
