...
class SHinterface extends JFrame implements ActionListener, MouseMotionListener, MouseListener,
        WindowListener {
    ...
    SHinterface()
    {
        ...
        System.out.println(this.getClass().getResource("/cards.gif"));
        ...
        menuItem = new JMenuItem("Multi Player Server",
                KeyEvent.VK_S);
        menuItem.getAccessibleContext().setAccessibleDescription(
        ...
        menuItem = new JMenuItem("Multi Player Client",
                KeyEvent.VK_C);
        menuItem.getAccessibleContext().setAccessibleDescription(
        ...
        menuItem = new JMenuItem("Close Connections",
                KeyEvent.VK_L);
        menuItem.getAccessibleContext().setAccessibleDescription(
        ...
        menuItem = new JMenuItem("AI Speed",
                KeyEvent.VK_A);
        menuItem.getAccessibleContext().setAccessibleDescription(
        ...
        if (label.equals("Quit")) {
            ...
            if (dealer != null || player != null) {
                ...
                if (playersName != "cancel#*#")
                {
                    ...
                    dealer = new Dealer(this, cardspic, g, hand, back, backSW, dealerD.fastgame(),
                            dealerD.seven(), dealerD.nine(), dealerD.swap(), pointer, burntPic,
                            score);
                ...
                if (!(playersName == "cancel#*#" || playersName.equals("")))
                {
                    ...
                    try {// outputting host name and ip address
                        ...
                        for (int n = 1; n < add.length; n++)
                            addMsg("Other IP Address: " + add[n].getHostAddress()); // Global IP
                                                                                    // address
            ...
            if (dealer != null || player != null) {
                ...
                if (!(playersName == "cancel" || servername == "cancel" || playersName.equals("") || servername
                        .equals(""))) {
                    message = new Message(this);
                    message.createConnection(servername, playersName);
                    player = new Player(this, cardspic, g, hand, back, backSW, burntPic, pointer,
                            score);
